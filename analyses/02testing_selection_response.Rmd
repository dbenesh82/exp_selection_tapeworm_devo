...
#     )%>%
#     # clean up some messiness
#   mutate(cop_block = if_else(cop_block == "_NA", NA_character_, cop_block), 
#          worm_full_sib_fam_id = if_else(worm_full_sib_fam_id == "_", NA_character_, worm_full_sib_fam_id),
#          worm_maternal_id = if_else(worm_maternal_id == "__", NA_character_, worm_maternal_id),
#          selection_line = if_else(selection_line == "", NA_character_, selection_line),
#          cop_id = if_else(cop_id == "", NA_character_, cop_id),
#          cop_stage_checking = if_else(cop_stage_checking == "", NA_character_, cop_stage_checking),
#          cop_remarks = if_else(cop_remarks == "", NA_character_, cop_remarks),
#          fish_id = if_else(fish_id %in% c("0_", "1_", "2_", "3_", "4_", "_"), NA_character_, fish_id),
#          fish_worm_remark = if_else(fish_worm_remark == "", NA_character_, fish_worm_remark),
#          eggs_clutch_id = gsub("NA_", "0_", eggs_clutch_id))%>%
#   mutate(eggs_maternal_id = if_else(grepl("0_", eggs_clutch_id),
#                                     paste0(eggs_clutch_id, "_", as.character(id)),
#                                     eggs_maternal_id)),
...
f3a <- ggplot(pred_cerc2%>%
  ...
  labs(y = "Proportion with cercomer 9 dpi",
       x = "Generation") +
